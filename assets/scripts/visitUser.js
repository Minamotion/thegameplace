...
function checkUser(json, user) {
	...
	if (!(u == null || u == undefined || u == '') || !u.disabled) {
		...
		if (u.desc !== null) {
			...
			if(user==100||user=='jerry'){while(document.getElementById('jerrystuff')==null){}setTimeout(()=>{document.getElementById('jerrystuff').innerHTML=jerrysaylist[randomInt(0,((Object.keys(jerrysaylist).length)-1))];},50);}
		}
